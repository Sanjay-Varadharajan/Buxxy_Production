package com.buxxy.buxxy_fraud_engine.engine.fraudrules.service;


import com.buxxy.buxxy_fraud_engine.engine.fraudrules.dto.FraudRuleCreateDTO;
import com.buxxy.buxxy_fraud_engine.engine.fraudrules.dto.FraudRuleResponseDTO;
...
public class FraudRuleService {
    ...
    public FraudRuleCreateDTO createRule(Principal principal, @Valid FraudRuleCreateDTO fraudRule) {
        ...
        auditLog.setAdmin(loggedInAdmin);
    ...
    public Page<FraudRuleResponseDTO> viewRules(Principal principal, Pageable pageable) {
        ...
        Admin loggedInAdmin=adminRepository.findByUserMailAndUserActiveTrue(
                principal.getName()
